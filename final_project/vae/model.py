...
class CCVAE2(nn.Module):
    def __init__(self):
        super(CCVAE2, self).__init__()
        # Encoder
        self.en1 = nn.Conv1d(1, 16, kernel_size=7, stride=3, bias=False)
        self.en2 = nn.Conv1d(16, 32, kernel_size=6, stride=3, bias=False)
        self.en3 = nn.Conv1d(32, 64, kernel_size=8, stride=3, bias=False)
        self.fc1 = nn.Linear(1088, 512)
        self.fc21 = nn.Linear(512, 256)
        self.fc22 = nn.Linear(512, 256)
        # Decoder
        self.fc3 = nn.Linear(260, 512)
        self.fc4 = nn.Linear(512, 1088)
        self.de1 = nn.ConvTranspose1d(64, 32, kernel_size=8, stride=3, bias=False)
        self.de2 = nn.ConvTranspose1d(32, 16, kernel_size=6, stride=3, bias=False)
        self.de3 = nn.ConvTranspose1d(16, 1, kernel_size=3, stride=3, bias=False)
